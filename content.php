		...
		<div class="col-sm-12 col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body book-ext-info">
					...
					6.《<?php echo $thiscat ->name;?>》是一本优秀小说,为了让作者:<?php echo waitig_gopt('ashu_cat_value_'.$thiscat->term_id);?>能提供更多更好崭新的作品，请您购买本书的VIP或极品全能学生完本、全本、完结版实体小说及多多宣传本书和推荐，也是对作者的一种另种支持!小说的未来，是需要您我共同的努力!
				</div>
			</div>
		</div>
